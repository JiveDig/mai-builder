...
async function init() {
  try {
    ...
    wp.blocks.registerBlockVariation('outermost/icon-block', {
      name: 'divider',
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Divider', 'mai-builder'),
      attributes: {
    ...
    wp.blocks.registerBlockStyle('outermost/icon-block', {
      name: 'divider',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Divider', 'mai-builder')
    });
  } catch (error) {
...
/******/ })()
;
//# sourceMappingURL=icon-block-divider.js.map